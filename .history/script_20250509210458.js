...
async function exportToPDF() {
    try {
        ...
        // En una implementación real, llamarías al backend para generar el PDF
        showError('Exportar a PDF no está implementado completamente');
        console.log('Simulando exportación a PDF para debate:', currentDebateId);
    } catch (error) {
